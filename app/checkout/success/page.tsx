      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[calc(100vh-64px)] max-w-3xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
          <div className="w-full text-center">
            ...
            <p className="mt-7 text-xs font-bold uppercase tracking-[0.16em] text-accent">
              Order confirmed
            </p>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                href="/#products"
                className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-accent px-6 text-sm font-bold text-accent-foreground shadow-lg shadow-accent/20 transition-all hover:-translate-y-0.5 hover:opacity-90 hover:shadow-xl sm:w-auto"
              >
                Continue shopping
              ...
              <Link
                href="/"
                className="inline-flex h-12 w-full items-center justify-center rounded-2xl border border-border bg-card px-6 text-sm font-bold transition-all hover:bg-muted sm:w-auto"
              >
                Back to home
              </Link>
            </div>
