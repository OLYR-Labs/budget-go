          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-7 max-w-lg text-sm leading-7 text-primary-foreground/65 xl:text-base">
                Manage inventory, orders, branches and deliveries
                from one secure workspace built for Budget Go.
              </p>
          ...
          <div className="relative z-10 w-full max-w-[430px]">
            ...
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm leading-6 text-muted-foreground">
                Sign in to manage your Budget Go branch and
...
function Feature({
  ...
  return (
    <div className="rounded-2xl border border-primary-foreground/10 bg-primary-foreground/[0.06] p-4 backdrop-blur-sm">
      ...
      <p className="mt-1 text-[10px] leading-4 text-primary-foreground/45">
        {description}
      </p>
    </div>
  );
