      ...
      <CardContent className="p-3">
        ...
        <div className="mt-3 flex items-center justify-between gap-1.5">
          ...
          <Button
            ...
            className={`h-8 shrink-0 rounded-lg px-2.5 text-[10px] transition-all duration-200 ${
              added
    ...
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <Badge
            variant="secondary"
            className="rounded-full border border-accent/10 bg-accent/10 px-2.5 py-0.5 text-[10px] text-accent"
          >
            Available nearby
          </Badge>
          ...
          <p className="mt-1 max-w-xl text-xs leading-5 text-muted-foreground sm:text-sm">
            Products currently available at the Ingiriya Budget Go branch.
          </p>
        </div>

        <Button
          variant="ghost"
          className="group w-fit rounded-xl px-2.5 text-xs font-semibold"
        >
          View all
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-border/80 bg-muted/20 px-6 py-10 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-xs leading-5 text-muted-foreground">
            There aren't any products available at this branch right now.
            Please check another location or come back later.
          </p>
