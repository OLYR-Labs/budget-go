  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#08080a] text-white">
        ...
        <div className="relative hidden min-h-[500px] lg:block">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative h-[380px] w-[380px]">
                ...
                <div className="flex h-full flex-col rounded-[2rem] border border-white/[0.07] bg-[#111114]/90 p-5">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white text-sm font-black text-black shadow-lg">
                        B
                      </div>
                  ...
                  <div className="mt-5 grid flex-1 grid-cols-2 gap-3">
                    ...
                    <div className="rounded-3xl border border-white/[0.06] bg-white/[0.045] p-3.5">
                      <div className="flex h-24 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500/20 to-purple-900/10">
                        <Package className="h-9 w-9 text-purple-300/80" />
                      </div>
                    ...
                    <div className="mt-7 rounded-3xl border border-white/[0.06] bg-white/[0.045] p-3.5">
                      <div className="flex h-24 items-center justify-center rounded-2xl bg-white/[0.04]">
                        <ShoppingBag className="h-9 w-9 text-white/40" />
                      </div>
                    ...
                    {/* Product 3 */}
                    <div className="rounded-3xl border border-white/[0.06] bg-white/[0.045] p-3.5">
                      <div className="flex h-20 items-center justify-center rounded-2xl bg-white/[0.035]">
              ...
              <div className="animate-float absolute -right-2 top-12 rounded-2xl border border-white/10 bg-[#151519]/90 px-4 py-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
                <div className="flex items-center gap-2.5">
                  <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-green-500/10">
                    <div className="h-2 w-2 rounded-full bg-green-400 shadow-[0_0_10px_rgba(74,222,128,0.7)]" />
                  </div>
              ...
              {/* Floating local */}
              <div
                className="animate-float absolute -bottom-2 -left-4 rounded-2xl border border-white/10 bg-[#151519]/90 px-4 py-3 shadow-2xl shadow-black/40 backdrop-blur-xl"
              ...
              {/* Floating basket */}
              <div
                className="animate-float absolute -left-8 top-28 rounded-2xl border border-white/10 bg-[#151519]/90 px-3.5 py-3 shadow-2xl shadow-black/40 backdrop-blur-xl"
                style={{ animationDelay: "1.4s" }}
              >
                <div className="flex items-center gap-2">
                  <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-purple-500/15 text-purple-300">
      ...
      {locationOpen && (
        ...
        >
          <div
            className="w-full max-w-md rounded-3xl border border-white/10 bg-[#111114] p-6 text-white shadow-2xl"
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-white/50">
                  Select the Budget Go branch you want to shop from.
                </p>
              </div>
              ...
              <button
                type="button"
                onClick={() => setLocationOpen(false)}
                className="rounded-xl px-3 py-2 text-white/40 transition-colors hover:bg-white/10 hover:text-white"
            ...
            <button
              type="button"
              onClick={() => setLocationOpen(false)}
              className="mt-6 flex w-full items-center gap-3 rounded-2xl border border-purple-400/20 bg-purple-500/10 p-4 text-left transition-colors hover:bg-purple-500/15"
            >
            ...
            <Button
              ...
              variant="outline"
              onClick={() => setLocationOpen(false)}
              className="mt-4 h-11 w-full rounded-2xl border-white/10 bg-white/[0.04] text-white hover:bg-white/[0.08] hover:text-white"
            >
              Done
            </Button>
          </div>
